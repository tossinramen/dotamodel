...
def fetch_massive_dataset(target_match_count=10000):
    print(f"Starting extraction for {target_match_count} matches...")
    print("Note: With rate limiting, pulling 10,000 detailed matches takes ~2.7 hours.")
    print("Progress is saved automatically. You can safely stop and restart this script.")
    ...
    for i, match_id in enumerate(match_ids_to_fetch):
        ...
        if res.status_code == 200:
            ...
            print(f"API Error {res.status_code}. Pausing for 60 seconds...")
            time.sleep(60) 
...
if __name__ == "__main__":
    fetch_massive_dataset(target_match_count=10000)